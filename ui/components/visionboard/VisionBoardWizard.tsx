...
export function VisionBoardWizard({ isOpen, onClose, onComplete, agentId }: VisionBoardWizardProps) {
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const newImages: VisionBoardImage[] = Array.from(files).map((file, index) => ({
            ...
            {step === 4 && (
              ...
              >
                ...
                <label className="block">
                  <div className="border-2 border-dashed border-oa-border rounded-lg p-8 text-center hover:border-oa-accent transition-colors cursor-pointer">
